<script lang="ts">
	...
	const pageTitle = 'Ematchi - Emoji matching';
	const pageDescription = 'the emoji matching game';
	const pageKeywords = 'emoji, game , matching , free , emoji matching , ';
	const pageAuthor = 'Ematchi Team';
</script>
